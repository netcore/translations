    ...
    init.push(function () {
        ...
        jQuery(document).ready(function($){
            ...
            $('.group-select').on('change', function(){
                var group = $(this).val();
                if (group) {
                    window.location.href = translations_index_route+'/'+$(this).val();
                } else {
                    window.location.href = translations_index_route;
                }
            });
            ...
            $("a.delete-key").click(function(event){
                ...
                $(this).closest('div.modal').modal('hide').on('hidden.bs.modal', function(){
        ...
        $('.locale_switching_form').on('change', function(){
            $(this).submit();
        });
